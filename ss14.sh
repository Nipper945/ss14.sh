...
#MAJORURL=
FULLVER=513.1524_byond.zip
FULLURL=http://www.byond.com/download/build/513/513.1524_byond.zip
...
then
    ...
    mkdir -p ziptmp
    unzip -qq 513.1524_byond.zip -d ziptmp
    ls ziptmp
    mv ziptmp/byond $SS13DIR/drive_c/Program\ Files/BYOND
    rm ./513.1524_byond.zip
    rm -rf ziptmp
    echo "513.1524_byond.zip" > $SS13DIR/.byondver
    echo -e "${BLUE}Done!${NC}"
else
